...
def train_hybrid(i):
    ...
    heat = AdvectionDiffusionReaction2M(device, L = 6.0, N = nX, dt=dt, num_steps=num_steps, material_boundary = (0, nX//2))
    ...
    torch.save(anode.state_dict(), f'Experiments/2materials/anode_{i}.pt')
    # # =============================================================================
    # # TESTING
    # # =============================================================================
    ...
    return heat.alpha1, heat.alpha2, heat.k1, heat.k2
...
def train(i):
    ...
    optimizer_heat = torch.optim.Adam(heat.parameters(), lr=1e-1)
    scheduler_anode = torch.optim.lr_scheduler.OneCycleLR(optimizer_anode, max_lr=learning_rate, steps_per_epoch=1, epochs=num_epochs)
    scheduler_heat = torch.optim.lr_scheduler.LambdaLR(optimizer_heat, lr_lambda=lambda epoch: 1.0e-3) #Just constant
    # =============================================================================
    # TRAINING
    # =============================================================================
