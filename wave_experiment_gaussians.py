...
from models.FEM import WaveEquationG
import numpy as np
...
def train_hybrid(i):
    ...
    heat = WaveEquationG(device, L, N, dt, num_steps, num_gaussians_alpha)
